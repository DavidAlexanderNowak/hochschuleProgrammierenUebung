...
public class RecursivePrintingOfMultiDimArray {
	private static final String XML_CONTAINER_START = "<container>";
	private static final String XML_CONTAINER_END = "</container>";
	private static final String XML_STRING_START = "<string>";
	private static final String XML_STRING_END = "</string>";
	...
	private static final String INDENT_THREE_SPACES= "   ";
	...
	static void printInXml(Object[] objs, String indent) {
		...
		for (Object obj : objs) {
			if (obj.getClass().isArray()) {
				System.out.println(indent + XML_CONTAINER_START);
				printInXml((Object[]) obj, indent + INDENT_THREE_SPACES);
				System.out.println(indent + XML_CONTAINER_END);
			} else {
				System.out.println(indent + XML_STRING_START + obj.toString().trim() + XML_STRING_END);
			}
		}
	}
