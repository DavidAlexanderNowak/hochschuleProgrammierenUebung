...
class Point2D
{
	private final int x, y;// 10.2.2 Nicht änderbar weil final. Können einmal (1) gesetzt werden im Konstruktor.

	/** Konstruktor */
	Point2D(int x, int y){
		this.x=x; this.y = y;// 10.2.1 'this' muss benutzt werden, um zwischen lokalen Variablen und
//								Instanzvariblen desselben Namen zu differenzieren.
	}
	 ...
	 * 10.2.3
	 * @return Punkt der Quasi relativ zum
	 */
	Point2D rotate90DEG(){
...
class Line2D
{
	...
	// 10.2.4 Literally die Antwort auf die Frage:
