...
public class RaumV2 {
	...
	public void setAnzahlPlaetze(int plaetze) {
		...
		if (plaetze < MINIMUM) {
			System.err.println("Die Anzahl der Plätze muss größer als " + (MINIMUM - 1) + " sein, ist aber "
					+ plaetze + ". Leider " + (MINIMUM - plaetze) + " zu wenig. ");
			// Ende des Semester werden Exceptions vorgestellt, die besser sind zur
			// Fehlerbehandlung ...
		} else {
